...
- **两位 analyzer 根因分歧 > 50%** → **不可跳过，必须暂停问用户**（熔断机制）
- **reviewer 否决改进措施（不够具体/不可执行）** → **不可跳过，必须暂停问用户确认改进方向**（熔断机制）
...
- **自主模式**：team lead 综合双方论证自行裁决，收尾时汇总
